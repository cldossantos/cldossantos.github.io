...
## Installing and loading the necesary packages
...
The *agridat* package contains a data set of yield observations collected from a corn field in Minessota, the data set name is [gartner.corn](https://kwstat.github.io/agridat/reference/gartner.corn.html).\
