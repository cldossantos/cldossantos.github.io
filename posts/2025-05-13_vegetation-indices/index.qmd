...
In this example, we'll focus on the [Ada Hayden Heritage Park](https://maps.app.goo.gl/235ypmts5sEZzVwWA). I will set up the corners here so you do not have to download any files to be able to reproduce follow along. 
```{r}
