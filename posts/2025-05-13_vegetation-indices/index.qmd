...
Researchers might be interested in using other vegetation indices to identify water bodies, for example, such as the [Multi-Band Water Index](https://www.sciencedirect.com/science/article/pii/S0303243418300990). This can be done by specifying the mathematical relationship between the Sentinel-2 bands in the *formula* argument of *pa_compute_vi()*.
