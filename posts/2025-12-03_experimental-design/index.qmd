...
::: {.callout-warning}
## Anti-Pattern
The next code chunk intentionally demonstrates a flawed analysis strategy (copying control observations across treatments). This violates independence assumptions and should not be used in real analyses.
:::
